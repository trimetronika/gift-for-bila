...
def write_happy_inside_circle(text_color, x, y):
    ...
    my_turtle_cursor.write("Happy Birthday", font=("sans-serif", 22, "bold"))
...
def write_birthday_inside_circle(text_color, x, y):
    ...
    my_turtle_cursor.write("Sabila!", font=("sans-serif", 22, "bold"))
...
my_turtle_screen.bgcolor("#AC52FF")

# # Creating an empty list of different parts of our cake
parts_of_cake = []
parts_of_cake.append(["#f38fa9", "#FFFFFF", 3, 30])
parts_of_cake.append(["#800000", "#FFFFFF", 3, 20])
parts_of_cake.append(["#7F2A3C", "#FFFFFF", 3, 60])

# drawing an plate for our cake using draw_layer_of_the_cake() function
draw_layer_of_the_cake("#FFC0CB", "#FFFFFF", 3, -220, y_coordinate - 70, 400, 10)
...
draw_candle_for_cake("#FFF44F", "#FFFFFF", -40, y_coordinate - 60)
...
draw_stick("#FFFFFF", "#FFFFFF", 0, y_coordinate - 60)

# Drawing a circle on top of stick
draw_circle_on_top_of_stick("#FFFFFF", "#FFFDD0", 100, y_coordinate + 235, 100)

# Writing "Happy" inside of our circle
write_happy_inside_circle("#FF559D", -80, y_coordinate + 240)

# Writing "Birthday" inside of our circle
write_birthday_inside_circle("#FF559D", -40, y_coordinate + 190)
